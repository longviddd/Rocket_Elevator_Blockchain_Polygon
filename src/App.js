...
function App() {
  ...
  const claimNFTs = async () => {
    ...
    let presale = await blockchain.smartContract.methods.checkIfPresaleOver().call();
    if(presale == true){
      cost = CONFIG.WEI_COST_PRESALE;
    }
                ...
                blockchain.smartContract === null ? (
                  ...
                  <>
                    ...
                    <s.Container ai={"center"} jc={"center"} fd={"row"}>
                      ...
                      >
                        {claimingNft ? "BUSY" : "BUY WITH MATIC"}
                      </StyledButton>
                      <StyledButton
                        disabled={claimingNft ? 1 : 0}
                        onClick={(e) => {
